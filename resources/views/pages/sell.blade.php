...
<head>
    ...
    <!-- Site Properties -->
    <title>BoxEstates | Selling</title>
...
<div class="ui large top fixed hidden menu">
    <div class="ui container">
        <div class="small-logo">
            <a href="{{'/'}}"><img src="assets/images/boxestates_logo.png"></a>
        </div>

        <div class="right menu">
            <div class="right item">
                <a href="{{'buy'}}" class="item">Buy</a>
                <a href="{{'sell'}}" class="item active">Sell</a>
...
<div class="pusher">
    ...
    <div class="wrapper sell">
        <div class="ui inverted vertical masthead center aligned segment sell">
            <div class="top-nav">
                <div class="ui container">
                    <div class="ui large secondary inverted pointing menu">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('assets/images/boxestates_logo.png') }}"></a>
                        </div>
